...
Entity\+List.\+cpp implements the header file \hyperlink{_entity_list_8h_source}{Entity\+List.\+h} Default constructor that creates an entity list then prints out the information \hypertarget{class_entity_list_a8725ad820c2bfb4fea8557c54d713b9b}{}\index{Entity\+List@{Entity\+List}!````~Entity\+List@{$\sim$\+Entity\+List}}
